...
👷 I build products 0->1 - from infrastructure and model pipelines to shipping production SaaS.
...
Frameworks/Tools: `PyTorch` `LangChain` `FastAPI` `Next.js` `NestJS` `React` · `PostgreSQL` `Docker` `AWS` `Grafana`
